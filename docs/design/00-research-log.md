...
> **Design record, written 2026-08-07.** Why each technology was chosen, with the
...
Google Cloud's Data Cloud team published the **Open Knowledge Format** on 2026-06-12 (v0.1), now at **v0.2**. It is not a niche curiosity. It is a vendor-neutral formalisation of exactly the Karpathy LLM-wiki pattern the brief points at.
...
- **Default (low volume):** Vercel AI Gateway's OpenAI-compatible `/embeddings` endpoint, one key, pass-through pricing, no idle cost.
